package it.polimi.ingsw.client.game_mode.gui.score_track;
...
public class ScoreTrackManager implements GUIManager {
    ...
    /**
     * It's called by the FXMLLoader when the file score_track.fxml is loaded.
     ...
     * passing him as parameter the score_track, which is a Table item
     */
    @Override
